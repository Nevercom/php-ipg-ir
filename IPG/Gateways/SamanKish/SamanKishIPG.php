...
/**
 * See
 * {@link https://www.sep.ir/%D8%AF%D8%B1%DB%8C%D8%A7%D9%81%D8%AA-%D8%AF%D8%B1%DA%AF%D8%A7%D9%87-%D8%A7%DB%8C%D9%86%D8%AA%D8%B1%D9%86%D8%AA%DB%8C- SamanKish Website} for more info
...
class SamanKishIPG extends AbstractIPG {
    ...
    public function startPayment($transactionId, $amount, $callbackUrl) {
        ...
        try {
            $result =
                $this->tokenservice->RequestToken($TermID, $ResNum, $TotalAmount, $SegAmount1, $SegAmount2, $SegAmount3,
                                                  $SegAmount4, $SegAmount5, $SegAmount6, $AdditionalData1,
                                                  $AdditionalData2, $Wage);
    ...
    public function inquiry($transactionId, $referenceId) {
        ...
        $verify = $this->verify($transactionId, $referenceId);

        $status = $verify->isSuccessful();
    ...
    public function verify($transactionId, $referenceId) {
        ...
        $status = $result > 0 && $result == $this->amount;
